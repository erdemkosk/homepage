...
date: '2021-07-21'
tags: ['nodejs', 'redis', 'rabbitmq', 'proje']
draft: false
summary: 'Headless mail consumer which is for sending mails and abstract it. If you want it controls blacklist from redis.'
layout: PostSimple
---
...
[Github](https://github.com/erdemkosk/rabbitmq-mail-consumer-server)
